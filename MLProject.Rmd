...
In this project, I choose Random Forest package  for prediction.

#Methodoloy

1. First I clean data : removing NA and not generalized data, user classes as factors.
2. Then I make a partition : 75% for traing data and 25 for test data.
3. I build a model : Classe as outcome and all other variables as predictors using random forest  as boosted tree machine learning algorithm."gmb" implementation takes a very long time.
